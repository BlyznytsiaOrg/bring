...
/**
 * The {@code ParameterSetValueTypeInjector} class is responsible for handling parameter injections for types of Set.
 * It extends the functionality of the AbstractValueTypeInjector and works in conjunction with a framework,
 * utilizing the bean registry and classpath scanner to recognize parameters of type Set. The injector extracts
 * implementation classes based on the generic type of the Set and injects the corresponding dependencies.
 *
 * @author Blyzhnytsia Team
 * @since 1.0
 */
public class ParameterSetValueTypeInjector extends AbstractValueTypeInjector implements ParameterValueTypeInjector{

    private final Reflections reflections;

    /**
     * Constructs a new instance of {@code ParameterSetValueTypeInjector}.
     *
     ...
     */
    public ParameterSetValueTypeInjector(Reflections reflections, AnnotationBringBeanRegistry beanRegistry,
     ...
     * @return {@code true} if the parameter is of type Set, {@code false} otherwise.
     */
    @Override
    public boolean hasAnnotatedWithValue(Parameter parameter) {
        return Set.class.isAssignableFrom(parameter.getType());
    }
