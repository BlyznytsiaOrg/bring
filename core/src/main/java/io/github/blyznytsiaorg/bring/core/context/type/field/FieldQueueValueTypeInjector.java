...
/**
 * The {@code FieldQueueValueTypeInjector} class is responsible for handling field injections for types of Queue.
 * It extends the functionality of the AbstractValueTypeInjector and works in conjunction with a framework,
 * utilizing the bean registry and classpath scanner to recognize fields of type Queue. However, this injector
 ...
 */
@Slf4j
public class FieldQueueValueTypeInjector extends AbstractValueTypeInjector implements FieldValueTypeInjector {

    private static final String UN_SUPPORTED_OPERATION_MESSAGE = "Queue type of injection is not supported, field: %s.";

    private final Reflections reflections;

    /**
     * Constructs a new instance of {@code FieldQueueValueTypeInjector}.
     *
     ...
     */
    public FieldQueueValueTypeInjector(Reflections reflections, AnnotationBringBeanRegistry beanRegistry,
     ...
     * @return {@code true} if the field is of type Queue, {@code false} otherwise.
     */
    @Override
