...
class BringApplicationContextHappyCasesTest {
    ...
    void shouldMixBeansConfigurationAndService() {
        ...
        Assertions.assertThat(beanB.getBeanA()).isNotNull();
        Assertions.assertThat(beanB.getBeanA()).isEqualTo(beanA);
    }
    ...
    void shouldInjectInterfaceBeanImplementation() {
        ...
        Assertions.assertThat(bean.getDrink().make()).isEqualTo("Making a delicious latte!");
    }
